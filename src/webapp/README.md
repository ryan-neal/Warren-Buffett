...
## Development environment and release process
 ...
 - create virtualenv with Flask and webapp installed into it (latter is installed in
...
install it (`pip install webapp.tar.gz`), ensure that configuration file exists and
`WEBAPP_SETTINGS` environment variable points to it, ensure that user has access to the
